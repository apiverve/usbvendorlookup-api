...
namespace APIVerve.API.USBVendorLookup
{
    ...
    /// <summary>
    /// Client for the USBVendorLookup API
    /// </summary>
    public class USBVendorLookupAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/usbvendorlookup";
        ...
        {
            { "vendorid", new ValidationRule { Type = "string", Required = true, MinLength = 4, MaxLength = 4 } },
            { "productid", new ValidationRule { Type = "string", Required = false, MinLength = 4, MaxLength = 4 } }
        };
        ...
        public USBVendorLookupAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public USBVendorLookupAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public USBVendorLookupAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, USBVendorLookupQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(USBVendorLookupQueryOptions options)
        {
        ...
        public ResponseObj Execute(USBVendorLookupQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(USBVendorLookupQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(USBVendorLookupQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(USBVendorLookupQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(USBVendorLookupQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(USBVendorLookupQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(USBVendorLookupQueryOptions options)
        {
