...
class usbvendorlookupWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/usbvendorlookup');
        }
        ...
        this.validationRules = {"vendorid":{"type":"string","required":true,"minLength":4,"maxLength":4},"productid":{"type":"string","required":false,"minLength":4,"maxLength":4}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/usbvendorlookup`);
        }
    }
...
module.exports = usbvendorlookupWrapper;
