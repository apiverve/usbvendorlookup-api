...
```gradle
dependencies {
    implementation 'com.github.apiverve:usbvendorlookup-api:1.1.13'
}
```
...
```java
import com.apiverve.usbvendorlookup.USBVendorLookupAPIClient;
import com.apiverve.usbvendorlookup.APIResponse;
import com.apiverve.usbvendorlookup.APIException;

// Initialize the client
USBVendorLookupAPIClient client = new USBVendorLookupAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/usbvendorlookup](https://docs.apiverve.com/ref/usbvendorlookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/usbvendorlookup](https://docs.apiverve.com/ref/usbvendorlookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/usbvendorlookup-api/issues)
