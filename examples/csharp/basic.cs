...
{
    class USBVendorLookupExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/usbvendorlookup";

        /// <summary>
        /// Make a GET request to the USB Vendor Lookup API
        /// </summary>
        static async Task<JsonDocument> CallUSBVendorLookupAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;vendorid&quot;] &#x3D; &quot;05AC&quot;, [&quot;productid&quot;] &#x3D; &quot;8290&quot; };
        ...
        {
            Console.WriteLine("📤 Calling USB Vendor Lookup API...\n");

            var result = await CallUSBVendorLookupAPI();
