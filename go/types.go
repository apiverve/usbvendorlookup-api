// Package usbvendorlookup provides a Go client for the USB Vendor Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/usbvendorlookup?utm_source=go&utm_medium=readme
package usbvendorlookup
...
// Request contains the parameters for the USB Vendor Lookup API.
//
// Parameters:
//   - vendorid (required): string - The USB vendor ID in 4-digit hex format (e.g., 05AC for Apple) [minLength: 4, maxLength: 4]
//   - productid: string - The USB product ID in 4-digit hex format (optional) [minLength: 4, maxLength: 4]
type Request struct {
	Vendorid string `json:"vendorid"` // Required
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"vendorid": {Type: "string", Required: true, MinLength: intPtr(4), MaxLength: intPtr(4)},
		"productid": {Type: "string", Required: false, MinLength: intPtr(4), MaxLength: intPtr(4)},
	}
...
// ResponseData contains the data returned by the USB Vendor Lookup API.
